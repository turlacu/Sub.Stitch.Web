...
export const PORTUGUESE: MarketingContent = {
  ...
  problem: {
    ...
    subtitle: "A maioria dos tradutores converte linha a linha de forma cega, estragando o diálogo. O Sub.Stich entende a cena inteira.",
    basicCard: {
    ...
    subaiCard: {
      title: "Tradutor Sub.Stich",
      desc: "Analisador com conhecimento de diálogo",
      recBadge: "RECOMENDADO",
      successLabel: "✓ Contexto conservado",
      successEx: "*Significado correto: O Sub.Stich entende a gíria e gera o equivalente natural.",
      traits: [
  ...
  howItWorks: {
    ...
    title: "Como funciona o Sub.Stich",
  ...
  features: {
    ...
    subtitle: "Os tradutores normais tratam o texto de forma isolada e fria. O Sub.Stich trata sua legenda como uma obra cinematográfica viva.",
    items: [
    ...
    subaiComp: "Otimização e Controle Sub.Stich:",
  ...
  faq: {
    ...
    items: [
      { question: "O Sub.Stich pode desajustar a sincronia da minha legenda?", answer: "Não, nunca. Tratamos os códigos de tempo originais como constantes exclusivas para leitura e geração. O parser retém o texto puro, efetua a tradução contextualmente e anexa-o nos exatos milissegundos originais." },
      { question: "É similar aos tradutores comuns Google ou DeepL?", answer: "Não. Tradutores genéricos traduzem linha por linha sem nexo. O motor inteligente do Sub.Stich junta as sentenças na mente da IA para compreender relacionamentos, sarcasmo e gênero dramático da cena." },
